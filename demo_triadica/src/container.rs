  ...
  group(vec![
    object(
      ...
      PackedAttrs::List(vec![
        PackedAttrs::Item(vec![("a_position".to_owned(), VertexDataValue::Vec3([0., 0., 0.]))]),
        PackedAttrs::Item(vec![("a_position".to_owned(), VertexDataValue::Vec3([100., 0., 0.]))]),
        PackedAttrs::Item(vec![("a_position".to_owned(), VertexDataValue::Vec3([0., 100., 0.]))]),
        PackedAttrs::Item(vec![("a_position".to_owned(), VertexDataValue::Vec3([0., 0., 0.]))]),
      ]),
      Rc::new(Vec::new),
    ),
